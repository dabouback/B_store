...
using B_store.Helpers;
using B_store.Models;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult>Register([FromBody] RegisterViewModel formdata)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return Ok(new { username = user.UserName, email = user.Email, status = 1, message = "Resgistration Successful" });
            }
            else
            {
